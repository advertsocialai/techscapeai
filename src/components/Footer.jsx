  ...
  return (
    <footer className="relative bg-black border-t border-white/[0.06]">
      <div className="wrap">
            ...
            <div key={cat}>
              ...
              <ul className="space-y-3">
                {links.map(({ label, href }) => (
                  <li key={label}>
                    {href.startsWith('/') ? (
                      <Link to={href} className="text-[13px] text-white/40 hover:text-white transition-colors">{label}</Link>
                    ) : (
        ...
        {/* Large wordmark — matching Figma footer */}
        <div className="py-10 text-center overflow-hidden">
          <h2 className="font-black leading-none select-none"
            style={{
            ...
            TechScape <span style={{
              background: 'linear-gradient(97.97deg, rgba(61,117,243,0.15) 0%, rgba(245,160,134,0.1) 100%)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent',
              backgroundClip: 'text',
            }}>AI</span>
